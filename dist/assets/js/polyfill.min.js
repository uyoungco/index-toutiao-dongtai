...
Array.prototype.map || (Array.prototype.map = function (r, e) {
  var t, o, n;if (null == this) throw new TypeError(" this is null or not defined");var i = Object(this),
      p = i.length >>> 0;if ("[object Function]" != Object.prototype.toString.call(r)) throw new TypeError(r + " is not a function");for (e && (t = e), o = new Array(p), n = 0; n < p;) {
    var c, a;n in i && (c = i[n], a = r.call(t, c, n, i), o[n] = a), n++;
  }return o;
}), Array.prototype.filter || (Array.prototype.filter = function (r) {
  if (null == this) throw new TypeError();var e = Object(this),
      t = e.length >>> 0;if ("function" != typeof r) throw new TypeError();for (var o = [], n = arguments[1], i = 0; i < t; i++) {
    if (i in e) {
      var p = e[i];r.call(n, p, i, e) && o.push(p);
    }
  }return o;
}), /\[native code\]/.test(Object.create) || (Object.create = function (r) {
  var e = function e() {};return e.prototype = r, new e();
});var origDefineProperty = Object.defineProperty,
    arePropertyDescriptorsSupported = function arePropertyDescriptorsSupported() {
  var r = {};try {
    for (var e in origDefineProperty(r, "x", { enumerable: !1, value: r }), r) {
      return !1;
    }return r.x === r;
  } catch (r) {
    return !1;
    ...
    supportsDescriptors = origDefineProperty && arePropertyDescriptorsSupported();supportsDescriptors || (Object.defineProperty = function (r, e, t) {
  if (origDefineProperty && 1 == r.nodeType) return origDefineProperty(r, e, t);r[e] = t.value || t.get && t.get();
}), "function" != typeof Object.assign && (Object.assign = function (r) {
  if (null == r) throw new TypeError("Can not convert undefined or null to object");for (var e = Object(r), t = 1, o = arguments.length; t < o; t++) {
    var n = arguments[t];if (null != n) for (var i in n) {
